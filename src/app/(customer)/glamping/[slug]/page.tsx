    ...
    <div className="container mx-auto px-4 py-12 max-w-6xl">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-16">
                    ...
                    {glamping.amenities.map((amenity, idx) => {
                        ...
                        return (
                            <div key={idx} className="flex items-center gap-4 p-4 rounded-2xl bg-white border border-black/5 hover:border-accent/30 transition-all group">
                                ...
                                <span className="text-sm font-black text-primary/70 uppercase tracking-widest">{amenity.name}</span>
                            </div>
                        );
                    })}
                </div>
        ...
        <div className="relative">
            <div className="sticky top-32 glass rounded-[3rem] p-10 border-white/40 shadow-2xl space-y-8 overflow-hidden">
                ...
                <div className="relative space-y-4">
                    <div className="grid grid-cols-2 gap-px bg-primary/10 rounded-2xl overflow-hidden border border-primary/10">
                         <div className="bg-white/50 p-4">
                            <div className="text-[10px] font-black uppercase tracking-widest text-primary/40 mb-1">Check-in</div>
                            <div className="text-sm font-black text-primary">Select Date</div>
                         </div>
                         <div className="bg-white/50 p-4">
                            <div className="text-[10px] font-black uppercase tracking-widest text-primary/40 mb-1">Check-out</div>
                            <div className="text-sm font-black text-primary">Select Date</div>
                         </div>
                    </div>
