...
import { LayoutDashboard, Users, Shield, FileText, LogOut, X, BarChart3, Layers, Wallet } from 'lucide-react';
...
const sidebarItems = [
  ...
  { icon: Wallet, label: { id: 'Penarikan', en: 'Withdrawals' }, href: '/admin/withdrawals' },
